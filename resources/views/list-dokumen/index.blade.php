            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if(in_array(Auth::user()->code_role, ['001', '002']))
                        <div class="mb-3">
                            <a href="{{ route('list-dokumen.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" style="gap:10px">
                                                <a href="{{ route('list-dokumen.show', $data->id) }}" class="btn btn-sm btn-info" title="View">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                @if(Auth::user()->code_role == '001')
                                                    <form action="{{ route('list-dokumen.destroy', $data->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
